...
namespace MatriculaUPC
{
    ...
    public partial class PC1_Web_20171Entities1 : DbContext
    {
        public PC1_Web_20171Entities1()
            : base("name=PC1_Web_20171Entities1")
        {
        }
        ...
        public virtual DbSet<DesarrolladorProyecto> DesarrolladorProyectoes { get; set; }
